...
@objc open class ACFloatingTextfield: UITextField {
    ...
    @IBInspectable open var selectedLineColor : UIColor = UIColor(red: 0/256.0, green: 0/256.0, blue: 0/256.0, alpha: 1.0){
        didSet{
            self.floatTheLabel()
        }
    }
    ...
    @IBInspectable open var selectedPlaceHolderColor : UIColor = UIColor(red: 0/256.0, green: 0/256.0, blue: 0/256.0, alpha: 1.0){
        didSet{
            self.floatTheLabel()
        }
    }
