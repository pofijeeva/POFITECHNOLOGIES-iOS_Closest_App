...
class LoginViewController: BaseViewController,WKNavigationDelegate, ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding,UITextFieldDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if choose == "en" {
            self.btnForgetPassWord.setTitle(LocalizeHelper().localizedStringForKey("frgtpswd"), for: .normal)
     self.txtEmail.placeholder = LocalizeHelper().localizedStringForKey("usernameplaceholder")
        self.txtPassword.placeholder = "PASSWORD";
            txtPassword.delegate = self
            self.idonthaveacc.text = LocalizeHelper().localizedStringForKey("donthaveacc")
            self.rememberme.text = LocalizeHelper().localizedStringForKey("rememberme")
            self.btnSignupNow.setTitle(LocalizeHelper().localizedStringForKey("signupcap"), for: .normal)
            //self.btnLinkedin.setTitle(LocalizeHelper().localizedStringForKey("linkedInlogin"), for: .normal)
            self.btnLinkedin.setTitle(LocalizeHelper().localizedStringForKey("signinwithapple"), for: .normal)
            self.btnFaceBook.setTitle(LocalizeHelper().localizedStringForKey("facebooksignup"), for: .normal)
            self.btnGooglePlus.setTitle(LocalizeHelper().localizedStringForKey("googlesignup"), for: .normal)
            ...
            self.txtPassword.text = GlobalLanguageDictionary.object(forKey: "Key_Password") as! String
