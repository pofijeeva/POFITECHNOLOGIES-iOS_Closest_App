...
class Mytrip : NSObject, NSCoding{
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        cancelShowStatus = dictionary["cancel_show_status"] as? Bool
        ...
        disputeShowStatus = dictionary["dispute_show_status"] as? Bool
        expiredate = dictionary["expiredate"] as? String
        guestEmail = dictionary["guest_email"] as? String
        guestId = dictionary["guest_id"] as? Int
        hostId = dictionary["host_id"] as? Int
        hostName = dictionary["host_name"] as? String
        houseRules = dictionary["house_rules"] as? String
        id = dictionary["id"] as? Int
        isCanceled = dictionary["is_canceled"] as? Bool
        isCouponUsed = dictionary["is_coupon_used"] as? String
        isDispute = dictionary["is_dispute"] as? Bool
        isPrevious = dictionary["is_previous"] as? Bool
        isReview = dictionary["is_review"] as? Bool
        isWalletUsed = dictionary["is_wallet_used"] as? String
        
        noofGuest = dictionary["NoofGuest"] as? Int
        numofdates = dictionary["numofdates"] as? Int
        ...
        reviewShowStatus = dictionary["review_show_status"] as? Bool
        securityDeposit = dictionary["security_deposit"] as? Float
        serviceFee = dictionary["service_fee"] as? Float
        showStatus = dictionary["show_status"] as? Bool
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        cancelShowStatus = aDecoder.decodeObject(forKey: "cancel_show_status") as? Bool
        ...
        disputeShowStatus = aDecoder.decodeObject(forKey: "dispute_show_status") as? Bool
        ...
        guestId = aDecoder.decodeObject(forKey: "guest_id") as? Int
        ...
        isCanceled = aDecoder.decodeObject(forKey: "is_canceled") as? Bool
        isCouponUsed = aDecoder.decodeObject(forKey: "is_coupon_used") as? String
        isDispute = aDecoder.decodeObject(forKey: "is_dispute") as? Bool
        isPrevious = aDecoder.decodeObject(forKey: "is_previous") as? Bool
        isReview = aDecoder.decodeObject(forKey: "is_review") as? Bool
        ...
        noofGuest = aDecoder.decodeObject(forKey: "NoofGuest") as? Int
        numofdates = aDecoder.decodeObject(forKey: "numofdates") as? Int
        ...
        reviewShowStatus = aDecoder.decodeObject(forKey: "review_show_status") as? Bool
        ...
        showStatus = aDecoder.decodeObject(forKey: "show_status") as? Bool
