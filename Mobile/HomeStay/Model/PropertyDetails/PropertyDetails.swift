...
class PropertyDetails : NSObject, NSCoding{
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        hostId = dictionary["host_id"] as? Int
         min_hour = dictionary["min_hour"] as? Int
          min_days = dictionary["min_days"] as? Int
        ...
        instantPayStatus = dictionary["instant_pay_status"] as? Int
        ...
        starRating = dictionary["star_rating"] as? Int
        state = dictionary["state"] as? String
        status = dictionary["status"] as? Int
        totalReviewCount = dictionary["total_review_count"] as? Int
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        hostId = aDecoder.decodeObject(forKey: "host_id") as? Int
         min_hour = aDecoder.decodeObject(forKey: "min_hour") as? Int
         min_days = aDecoder.decodeObject(forKey: "min_days") as? Int
        ...
        instantPayStatus = aDecoder.decodeObject(forKey: "instant_pay_status") as? Int
        ...
        starRating = aDecoder.decodeObject(forKey: "star_rating") as? Int
        state = aDecoder.decodeObject(forKey: "state") as? String
        status = aDecoder.decodeObject(forKey: "status") as? Int
        totalReviewCount = aDecoder.decodeObject(forKey: "total_review_count") as? Int
