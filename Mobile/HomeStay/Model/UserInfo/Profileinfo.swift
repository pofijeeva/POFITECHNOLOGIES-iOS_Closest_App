...
class Profileinfo : NSObject, NSCoding{
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        cancellationAboutYouCount = dictionary["cancellation_aboutYou_count"] as? Int ?? 0
        cancellationByYouCount = dictionary["cancellation_byYou_count"] as? Int ?? 0
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        cancellationAboutYouCount = aDecoder.decodeObject(forKey: "cancellation_aboutYou_count") as? Int ?? 0
        cancellationByYouCount = aDecoder.decodeObject(forKey: "cancellation_byYou_count") as? Int ?? 0
