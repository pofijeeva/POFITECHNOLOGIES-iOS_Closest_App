...
class PayoutMethodCell: UITableViewCell {
    ...
    @IBOutlet weak var BankAddImgBtn: UIButton!
    @IBOutlet weak var PayPalAddImgBtn: UIButton!
    
    @IBOutlet weak var BankAddBtn: UIButton!
    @IBOutlet weak var PayPalAddBtn: UIButton!
