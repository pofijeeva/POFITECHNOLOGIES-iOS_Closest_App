...
//        WalletApi()
       // self.PaymentFor = "Booking"
        //self.PaymentDoneLbl.font = UIFont(name: SemiBoldFont, size: 25)
        //self.TransSuccessLbl.font = UIFont(name: SemiBoldFont, size: 13)
...
//            self.navigationController?.pushViewController(nav!, animated: true)
    ...
    @IBAction func act_PayNow(_ sender: UIButton) {
        ...
        if self.choosePaymentType == "" {
            self.showInformation(title: "Error", message: "Please select any payment type")
    ...
    func isValidCard() {
        ...
        if tempCardType?.text! == "Choose your card"{
            ...
            self.showInformation(title: "Error", message: "Enter CVV")
...
,
                                ...
                                "booking_type":"1" ,//1-Daily,2-Hourly
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            if indexPath.row == 0 {
                ...
                cell!.TypeName.text = "Do you have a Coupon code ?"
            ...
            if indexPath.row == 0 {
                ...
                cell!.selectionStyle = .none
                cell!.TypeName.text = "Cash in wallet"
        ...
        }else 
        {
            ...
            if indexPath.row == 0 && self.choosePaymentType == "Stripe" {
                ...
                if self.choosePaymentType == "Stripe" {
                    cell!.SelectPaymentTypeLbl.text = "Credit/ Debit card"
...
//                }
                ...
                cell!.TypeImg.image = UIImage(named: "Image-7")
                
                if self.PaymentsArray.object(at: indexPath.row) as? String == "Stripe" {
                    cell!.TypeName.text = "Credit/ Debit card"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.section == 0 {
            ...
            if indexPath.row == 0 {
                ...
                if balenceWalletPrice == "0"{
                 self.WalletShow = 1
                    self.showInformation(title: "Closest", message: "You don't have cash in your wallet")
                }else{
                    self.WalletShow = 2
                }
                self.ChoosePaymentInt = 0
            ...
            if indexPath.row == 0 {
                ...
                self.ChoosePaymentInt = 1
                self.choosePaymentType = "Credit Card"
            }
        }
