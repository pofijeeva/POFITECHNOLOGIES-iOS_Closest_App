...
//        print(UIFont.fontNames(forFamilyName: "Sofia Pro"))
        ...
        BTAppSwitch.setReturnURLScheme("com.boatRental.payments")
...
//s
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplicationOpenURLOptionsKey : Any] = [:]) -> Bool
    {
        ...
        if url.scheme?.localizedCaseInsensitiveCompare("com.boatRental.payments") == .orderedSame {
    ...
    func application(_ application: UIApplication, open url: URL, sourceApplication: String?, annotation: Any) -> Bool
    {
        ...
        else if url.scheme?.localizedCaseInsensitiveCompare("com.boatRental.payments") == .orderedSame {
