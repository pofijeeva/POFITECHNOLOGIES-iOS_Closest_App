...
//        let checks = check.date(from: "2018-12-27")
//        calendar.deselect(checks!)
...
//    
//    func calendar(_ calendar: FSCalendar, shouldSelect date: Date, at monthPosition: FSCalendarMonthPosition)   -> Bool {
//        if(date == formatter.date(from: "2018-12-25"))
//        {
//            return false
//        }
//        else
...
//        let checks = check.date(from: "2018-12-27")
//        print(checks)
//        print("did select date \(self.formatter.string(from: checks!))")
//        
//        
//      
//        
