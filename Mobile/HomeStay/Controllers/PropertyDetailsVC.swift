...
//        }
    ...
    func populateData() {
            ...
            self.dayPriceLbl.attributedText  = totalBookingAttributeString(harcodName: "\(login_session.value(forKey: "APP_CURRENCYSYM") as? String ?? "$") \((self.ReservationData.object(forKey: "property_details") as! NSDictionary).object(forKey: "price_list") as AnyObject)", name: "  /day", firstStringColor: AppColor)
            
            self.nameLbl.text = (self.ReservationData.object(forKey: "property_details") as! NSDictionary).object(forKey: "ren_title") as! String
...
//            let imggURL =  model.ren_image ?? ""
            ...
            self.totalBookingsLbl.attributedText =  totalBookingAttributeString(harcodName: "TOTAL BOOKING:  ", name: "\((self.ReservationData.object(forKey: "property_details") as! NSDictionary).object(forKey: "booking_count") as AnyObject)")
            self.cancelledLbl.attributedText = totalBookingAttributeString(harcodName: "CANCELLED BOOKING:  ", name: "\((self.ReservationData.object(forKey: "property_details") as! NSDictionary).object(forKey: "cancel_bk_count") as AnyObject)")
            self.receivedLbl.attributedText = totalBookingAttributeString(harcodName: "RECIVED:  ", name: "\(login_session.value(forKey: "APP_CURRENCYSYM") as? String ?? "$") \((self.ReservationData.object(forKey: "property_details") as! NSDictionary).object(forKey: "received_amnt") as AnyObject)", secondStringColor: AppColor)
            self.totalEarningsLbl.attributedText =  totalBookingAttributeString(harcodName: "TOTAL EARNINGS:  ", name: "\(login_session.value(forKey: "APP_CURRENCYSYM") as? String ?? "$") \((self.ReservationData.object(forKey: "property_details") as! NSDictionary).object(forKey: "total_amnt") as AnyObject)")
...
//                        self.isLoading = false
    ...
    @IBAction func bookedCustomersAct(_ sender: Any) {
        if (self.ReservationData.object(forKey: "booking_list") as! NSArray).count == 0 {
            self.showInformation(title: "Info", message: "We don't have any booked customers details to display")
