...
class NewBookingViewController: BaseViewController,DateTimePickerDelegate,SambagTimePickerViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if self.DatesMutable.count != 0 {
            ...
            for i in 0..<cnt{
                print(((self.DatesMutable.object(at: i)) as AnyObject).value(forKey: "DateStatus") as? Int ?? 0)
                ...
                }else if ((self.DatesMutable.object(at: i)) as AnyObject).value(forKey: "DateStatus") as? Int ?? 0 == 2 {
                    let date = ((self.DatesMutable.object(at: i)) as AnyObject).value(forKey: "DateString") as? String
    ...
    func DayCalcAPI()
    {
        ...
        APIManager.apiPostWithHeaders(serviceName: DAY_CALC_API, parameters: params) { (json:NSDictionary?, error:NSError?) in
            ...
            if responseDict.value(forKey: "code") as? NSNumber ?? 0 == 200 {
                ...
                //   let BookedDays = responseDict.value(forKey: "total_days") as? Int ?? 0
        ...
        //                self.no_of_days = "\(responseDict.value(forKey: "no_of_days") as AnyObject)"
        //                self.no_of_months = "\(responseDict.value(forKey: "no_of_months") as AnyObject)"
        //                //                                                    self.numWeeks = responseDict.value(forKey: "no_of_weeks") as? Int ?? 0
        //                //                                                    self.numMonths = responseDict.value(forKey: "no_of_months") as? Int ?? 0
        //                self.numDates = "\(BookedDays)"
...
//        picker.includeMonth = true // if true the month shows at bottom of date cell
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            if indexPath.row == 0 {
                guard let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookImageTableViewCell") as? ReqBookImageTableViewCell else { return UITableViewCell() }
//                let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookImageTableViewCell") as? ReqBookImageTableViewCell
                ...
                guard let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookGuestTableViewCell") as? ReqBookGuestTableViewCell else { return UITableViewCell() }
...
//                let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookGuestTableViewCell") as? ReqBookGuestTableViewCell
                ...
                guard let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookStaticPriceTableViewCell") as? ReqBookStaticPriceTableViewCell else { return UITableViewCell() }
...
//                let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookStaticPriceTableViewCell") as? ReqBookStaticPriceTableViewCell
                ...
                guard let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookCalenderTableViewCell") as? ReqBookCalenderTableViewCell else { return UITableViewCell() }
...
//                let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookCalenderTableViewCell") as? ReqBookCalenderTableViewCell
            ...
            guard let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookTimeTableViewCell") as? ReqBookTimeTableViewCell else { return UITableViewCell() }
...
//            let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookTimeTableViewCell") as? ReqBookTimeTableViewCell
        ...
        {
            guard let cell = tableView.dequeueReusableCell(withIdentifier: "ReqBookPriceTableViewCell") as? ReqBookPriceTableViewCell else { return UITableViewCell() }
