...
extension CouponsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.lblCarName.text = "For Property:" + " " + (couponObj["ren_title"] as! String)
        cell?.lblCode.text = "Code:" + " " + (couponObj["coupon_code"] as! String)
        cell?.lblValidDate.text = "valid to: " + (couponObj["dateto"] as! String).stringToDateFormatter(toFormate: "yyyy-MM-dd", fromFormate: "dd MMM,yyyy")
        return cell!
    }
