...
class BookedCustomerVC: BaseViewController {
    ...
    override func viewDidLoad() {
       ...
       // listTableview.register(UINib(nibName: "NewTableViewCell", bundle: nil), forCellReuseIdentifier: "NewTableViewCell")
...
extension BookedCustomerVC : UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       // guard let cell = tableView.dequeueReusableCell(withIdentifier: "NewTableViewCell", for: indexPath) as? NewTableViewCell else { return UITableViewCell() }
        ...
        cell.nameLbl.text = "\(DataDict.object(forKey: "prop_title") as! String) ( * \(DataDict.object(forKey: "booking_qty") as AnyObject))"
